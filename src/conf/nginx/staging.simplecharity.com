...
include forge-conf/staging.simplecharity.org/before/*;
...
server {
    ...
    server_name staging.simplecharity.org;
    root /home/forge/staging.simplecharity.org/current/web;
    ...
    access_log off;
    error_log  /var/log/nginx/staging.simplecharity.org-error.log error;
    # If you want error logging to go to SYSLOG (for services like Papertrailapp.com), uncomment the following:
    #error_log syslog:server=unix:/dev/log,facility=local7,tag=nginx,severity=error;

    # FORGE SSL (DO NOT REMOVE!)
    ssl_certificate /etc/nginx/ssl/staging.simplecharity.org/601368/server.crt;
    ssl_certificate_key /etc/nginx/ssl/staging.simplecharity.org/601368/server.key;
    ...
    # FORGE CONFIG (DO NOT REMOVE!)
    include forge-conf/staging.simplecharity.org/server/*;
    ...
    location ~ [^/]\.php(/|$) {
        ...
        fastcgi_param HTTP_HOST staging.simplecharity.org;

        # Use Dotenvy to generate the .env variables as per: https://github.com/nystudio107/dotenvy
        include /home/forge/staging.simplecharity.org/current/.env_nginx.txt;
...
# FORGE CONFIG (DO NOT REMOVE!)
include forge-conf/staging.simplecharity.org/after/*;
